...
const boxes: BoxItem[] = [
  {
    ...
    description: "Learn legal concepts with AI educators.",
    features: [
      "📚 Interactive Learning Sessions",
      "🎓 Expert AI Legal Educators",
      "📝 Practice Scenarios",
  ...
  },
  {
    ...
    title: "Debate Module",
    description: "Practice legal debates with AI opponents.",
    features: [
      "⚖️ AI-Powered Debate Simulations",
  ...
  },
  {
    ...
    description: "Get AI legal advice and consultations.",
    features: [
